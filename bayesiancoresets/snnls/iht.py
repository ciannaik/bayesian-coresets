...
# Implements the A-IHT II method from
...
# Code adapted from https://github.com/jackyzyb/bayesian-coresets-optimization/blob/master/IHT_toolbox/accelerated_iht.py
