...
do
    ...
    python3 main.py --model lr --dataset $dnm plot coreset_size gauss_mmd --groupby coreset_size --plot_type line --plot_legend alg --plot_x_label "Coreset Size" --plot_y_label "Gauss MMD Discr."
