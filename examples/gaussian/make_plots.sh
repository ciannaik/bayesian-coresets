...
python3 main.py --samples_inference 1000 --dataset synth_gauss plot coreset_size mu_err --plot_toolbar --groupby coreset_size --plot_type line --plot_legend alg --plot_y_type linear --plot_x_label "Coreset Size" --plot_y_label "Relative Mean Error"
python3 main.py --samples_inference 1000 --dataset synth_gauss plot coreset_size Sig_err --plot_toolbar  --groupby coreset_size --plot_type line --plot_legend alg --plot_y_type linear --plot_x_label "Coreset Size" --plot_y_label "Relative Cov Error"
...
python3 main.py --samples_inference 1000 --dataset synth_gauss plot coreset_size fklw --plot_toolbar --groupby coreset_size --plot_type line --plot_legend alg --plot_x_label "Coreset Size" --plot_y_label "Forward KL"
python3 main.py --samples_inference 1000 --dataset synth_gauss plot coreset_size rklw --plot_toolbar --groupby coreset_size --plot_type line --plot_legend alg --plot_x_label "Coreset Size" --plot_y_label "Reverse KL"
python3 main.py --samples_inference 1000 --dataset synth_gauss plot coreset_size t_build --plot_toolbar --groupby coreset_size --plot_type line --plot_legend alg --plot_x_label "Coreset Size" --plot_y_label "Build Time (s)"
python3 main.py --samples_inference 1000 --dataset synth_gauss plot coreset_size t_per_sample --plot_toolbar --groupby coreset_size --plot_type line --plot_legend alg --plot_x_label "Coreset Size" --plot_y_label "Per Sample Time (s)"
